<template>
    <div class="position-absolute top-50 start-50 translate-middle border p-5 rounded shadow">
        <h1 class="text-center">Soma dos números pares</h1>
        ...
        <h3 v-if="somaPares != null" class="mt-3 text-center">A soma dos números pares entre {{ inicio }} e {{ fim }} é {{ somaPares }}</h3>
    </div>
</template>
